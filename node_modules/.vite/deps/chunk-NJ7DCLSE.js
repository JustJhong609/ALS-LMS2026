...
var h2 = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-CBzELu-H-35MSLR4G.js")).iosTransitionAnimation : (await import("./p-CU1SSH8_-3YJTC6UT.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
...
@ionic/core/components/p-9VcRUwdB.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NJ7DCLSE.js.map
